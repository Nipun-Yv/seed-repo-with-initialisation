...
import { Undo2, Redo2, Trash2, Upload, ImageOff, Palette } from "lucide-react";
    ...
    return (
        <div className="flex items-center justify-between w-full p-1 bg-white/90 backdrop-blur-sm border border-slate-200 rounded-xl shadow-sm">
            ...
            <button 
                ...
                className="group flex items-center gap-1.5 px-2 py-1.5 rounded-lg transition-all text-slate-500 hover:bg-indigo-50 hover:text-indigo-600"
                title="Upload Image (or drag & drop)"
            >
                <Upload size={14} />
                <span className="text-[10px] font-bold uppercase tracking-tight leading-none">Upload</span>
            </button>
